...
export const faqData = [
  {
    ...
    answer: "Remplissez notre formulaire en ligne en quelques minutes. Vous recevez votre estimation par email en quelques minutes, puis un conseiller ERA DUPONT ROMAIN IMMOBILIER vous rappelle sous 24 h ouvrées si vous le souhaitez. C'est gratuit et sans engagement de durée."
  },
  {
